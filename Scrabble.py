...
# We want to create a function that will take in a word and return how many points that word is worth.Define a function called score_word that takes in a parameter word.
def score_word(word):
  point_total = 0
  for letter in word:
...
play_word("player1", "aaaAAAAAAAAAAAAAAAAAAA")
